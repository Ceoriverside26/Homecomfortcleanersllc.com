const CACHE='hcc-employee-v7';
const ASSETS=['./','./index.html','./management.html','./jobs-management.html','./team-lead.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
